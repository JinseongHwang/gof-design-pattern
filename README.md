...
[A. 생성 패턴 (Creational Patterns)](#a--------creational-patterns-)
* [A-1. 싱글톤 패턴 (Singleton)](#a-1---------singleton-)
* [A-2. 팩토리 메서드 패턴 (Factory method)](#a-2-------------factory-method-)
...
* [B-3. 컴포짓 패턴 (Composite)](#b-3---------composite-)
* [B-4. 데코레이터 패턴 (Decorator)](#b-4-----------decorator-)
...
* [C-3. 인터프리터 패턴 (Interpreter)](#c-3-----------interpreter-)
* [C-4. 이터레이터 패턴 (Iterator)](#c-4-----------iterator-)
* [C-5. 중재자 패턴 (Mediator)](#c-5---------mediator-)
* [C-6. 메멘토 패턴 (Memento)](#c-6---------memento-)
* [C-7. 옵저버 패턴 (Observer)](#c-7---------observer-)
* [C-8. 상태 패턴 (State)](#c-8--------state-)
* [C-9. 전략 패턴 (Strategy)](#c-9--------strategy-)
* [C-10. 템플릿 메서드 패턴 (Template method)](#c-10-------------template-method-)
* [C-11. 비지터 패턴 (Visitor)](#c-11---------visitor-)
